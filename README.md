...
- [x] **`Entity Sliders`**: entity transforms into slider - thanks @tmaihoff, @hfalk, @benjycov, @pygillier
- [x] **`Entity Badges`**: dynamic badge overlays - thanks @ojm88, @guillochon, @jmll959
